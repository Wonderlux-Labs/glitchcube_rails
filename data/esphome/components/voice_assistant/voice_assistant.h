...
class VoiceAssistant : public Component {
 ...
 protected:
  ...
  // GLITCHCUBE PATCH (VPE #563): consecutive playback-timeout re-arms while the
  // announcement is still in URL_SENT (not yet playing); bounds the wait for a
  // failed announcement.
  uint8_t playback_start_retries_{0};
