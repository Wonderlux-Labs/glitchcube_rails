...
RSpec.describe WorldStateUpdaters::ConversationSummarizerService, type: :service do
  ...
  describe '#call' do
    ...
    context 'when LLM call fails' do
      ...
      it 'raises service error' do
        expect { service.call }.to raise_error(described_class::Error, /Failed to generate conversation summary/)
      end
    end
  end
  ...
  describe 'error handling' do
    ...
    context 'when JSON parsing fails' do
      ...
      it 'uses fallback parsing with goal_progress' do
        summary = service.call
        
        metadata = summary.metadata_json
        expect(metadata['goal_progress']).to be_present
