...
# Invoked async (via MemorySearchJob) when the brain emits `search_memories`;
# results surface on the next turn. Answers things like "do I have a memory of a
# storm?" (keyword) or "any events happening tomorrow?" (category + timeframe).
